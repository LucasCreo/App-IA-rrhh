...
import { MisLicencias } from '@/components/empleado/MisLicencias'

export default async function EmpleadoLicenciasPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="h-14 border-b border-border bg-background flex items-center px-6 gap-3">
        ...
        <h1 className="font-semibold text-green-900 dark:text-green-400">Licencias</h1>
      </header>
